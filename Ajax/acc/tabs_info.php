...
$result_t=mysql_time_query($link,'Select A.* from z_acc as A where A.id="'.ht($id).'"');
...
if($id_tabs==1)
{
    include $url_system.'acc/code/tabs_info.php';
}

// процесс/задача
if($id_tabs==2)
{
    include $url_system.'acc/code/tabs_task.php';
}
