...
mysql_time_query($link,'INSERT INTO i_implementer (implementer,name_team,fio,tel) VALUES ("'.htmlspecialchars(trim($names)).'","'.htmlspecialchars(trim($name)).'","'.htmlspecialchars(trim($fio)).';'.htmlspecialchars(trim($fio1)).'","'.htmlspecialchars(trim($tel)).'")');
