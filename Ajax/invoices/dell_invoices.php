...
if(!token_access_new($token,'dell_invoice_xx',$id,"s_form"))
{
...
//**************************************************
$result_t=mysql_time_query($link,'Select b.* from z_invoice as b where b.id="'.$id.'"');
...
mysql_time_query($link,'delete FROM z_invoice where id="'.htmlspecialchars(trim($_GET['id'])).'"');
