...
$result_town=mysql_time_query($link,'Select a.id,a.object_name from i_object as a where a.id_kvartal="'.htmlspecialchars(trim($_GET['id'])).'" order by a.id');
	
                 $num_results_custom_town = $result_town->num_rows;
                 if($num_results_custom_town!=0)
                 {
							   $echo.='<div class="select_box eddd_box" style="float:none; z-index:121;"><a class="slct_box_form ee_group" data_src="0"><span class="ccol">Объект</span></a><ul class="drop_box_form">';
		    $echo.='<li class="sel_active"><a href="javascript:void(0);"  rel="0">Любой</a></li>'; 
             ...
             {  
               ...
               { 
				  ...
				  $echo.='<li><a href="javascript:void(0);"  rel="'.$row_t["id"].'">'.$row_t["object_name"].'</a></li>'; 
			   
			   }
			 } 
		       $echo.='</ul><input name="stock_object_" id="stock_object_" value="0" type="hidden"></div>';   	
