...
$result_t=mysql_time_query($link,'Select A.* from n_nariad as A where A.id="'.ht($id).'"');
...
if($id_tabs==1)
{
    include $url_system.'worder/code/tabs_info.php';
}

// процесс/задача
if($id_tabs==2)
{
    include $url_system.'worder/code/tabs_task.php';
}

// история
if($id_tabs==3)
{
    include $url_system.'worder/code/tabs_history.php';
}
