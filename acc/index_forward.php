...
$title=$kto.' перенаправил счет №'.$value['id'];


$kto1=name_sql_x($_POST["forward_id"]);


$message=$kto.' перенаправил <a class="link-history" href="acc/'.$value['id'].'/">Счет №'.$value['number'].' от '.date_ex(0,$value['date']).'</a>. Счет перенаправлен к - '.$kto1;
