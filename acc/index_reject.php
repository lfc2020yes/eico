...
$title=$kto.' отклонил счет №'.$value['number'];


$message=$kto.' отклонил <a class="link-history" href="acc/'.$value['id'].'/">Счет №'.$value['number'].' от '.date_ex(0,$value['date']).'</a>. Причина - '.$_POST["remark"].'.';
