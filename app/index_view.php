...
//***************************************************************************************************************************		
                  ...
                  <td colspan="1" class="no_padding_left_ pre-wrap one_td"><div class="nm"><span class="s_j">'. $row1ss["material"].'</span></div><input type=hidden value="'.$row_work_zz["id"].'" name="mat_zz['.$i.'][id]"><input type=hidden class="hidden_max_count" value="" name="mat_zz['.$i.'][max_count]">';
