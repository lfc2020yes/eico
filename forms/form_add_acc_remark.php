...
<?
			echo'<h1 style="margin-bottom: 0px;" class="h111 gloab-cc js-form2" mor="'.$token.'" for="'.htmlspecialchars(trim($_GET['id'])).'"><span>Добавление замечания</span><span class="clock_table"></span></h1><span class="tii">Счет №'.$value["number"].' от '.date_ex(0,$value["date"]).'</span></div><div class="center_modal"><div class="form-panel white-panel form-panel-form" style="padding-bottom: 10px;">';
