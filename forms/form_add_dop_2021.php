...
echo'</div>';
            ...
            $result_t2=mysql_time_query($link,'Select a.* from i_material as a where a.id_razdel2="'.ht($_GET["id"]).'" order by a.id');
