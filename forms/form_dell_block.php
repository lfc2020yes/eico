<?php
//форма удаление раздела в себестоимости
...
<?
			echo'<h1 class="h111" mor="'.$token.'" for="'.htmlspecialchars(trim($_GET['id'])).'"><span>Удаление раздела</span></h1>';
...
?>	
			...
			<br>
 <div class="over">           
<div id="yes_rd" class="save_button"><i>Удалить</i></div>
