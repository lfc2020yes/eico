...
$token=token_access_compile($_GET['id'],'dell_stock_',$secret);
//составление секретного ключа формы
//составление секретного ключа формы
//составление секретного ключа формы
...
<?
			echo'<h1 class="h111" mor="'.$token.'" for="'.htmlspecialchars(trim($_GET['id'])).'"><span>Удалить наименование</span></h1>';
...
echo'<div class="comme">Вы точно хотите удалить наименование - <b>"'.$row_t["name"].'"</b>?</div>';
	...
	?>
			...
			<br>
 <div class="over">           
<div id="yes_dell_stock" class="save_button"><i>Ок</i></div>
