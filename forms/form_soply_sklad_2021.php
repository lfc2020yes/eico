...
$result_tdd=mysql_time_query($link,'Select a.id,a.id_stock,b.material from z_doc_material as a,i_material as b where a.id_i_material=b.id and a.id="'.htmlspecialchars(trim($_GET["id"])).'"');
...
<div id="Modal-one" class="box-modal js-box-modal-two table-modal eddd1 input-block-2020"><div class="box-modal-pading"><div class="top_modal"><div class="box-modal_close arcticmodal-close"></div>
            ...
            echo'<h1 style="margin-bottom:0px;" class="h111 gloab-cc js-form2" mor="'.$token.'" for="'.htmlspecialchars(trim($_GET['id'])).'" ><span>Связь со складом</span><span class="clock_table"></span></h1><span class="tii">'.$row_list["material"].'</span></div><div class="center_modal"><div class="form-panel white-panel form-panel-form" style="padding-bottom: 10px;">';
