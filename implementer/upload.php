...
if ((isset($_POST["id"]))and((is_numeric($_POST["id"])))) 
{
	  ...
	  { 
	     ...
	     { 
		   ...
		   $result_t=mysql_time_query($link,'Select a.*,b.summa_debt from c_cash as a,i_implementer as b where a.id_implementer=b.id and a.id="'.htmlspecialchars(trim($_POST['id'])).'"');
