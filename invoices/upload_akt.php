...
if ((isset($_POST["id"]))and((is_numeric($_POST["id"])))) 
{
	...
	mysql_time_query($link,'INSERT INTO z_invoice_attach_defect (id_invoice_material,name,type,type_invoice,displayOrder,visible) VALUES ("'.htmlspecialchars(trim($_POST["id"])).'","","","0","0","0")');
