...
*/
       ...
       foreach ($value['data'] as $key1 => $value1)
    {
        ...
        $str =$value["file"];
        $str = iconv("windows-1251", "utf-8", $value["file"]); /* Преобразование кодировки */
...
</span><a style="display:block;" href="invoices_1c/'.$str.'/"><span class="spans ggh-e name-blue"><span>Накладная №'.$value1["Номер"].'</span></span></a><div id_status="9" class="status_admin js-status-preorders s_pr_2 ">не обработана</div><div class="pass_wh_trips" style="margin-top: 10px;"><label>Дата создания</label><div class="obi">'.$date_start .'</div></div></div><div class="trips-b-user"><span class="label-task-gg ">Контрагент
