...
if(($error_header!=404)and(isset($_GET['add']))){
	...
	if($num_results_t__!=0)
	{
		...
		setcookie($b_co."_".htmlspecialchars(trim($_GET['id'])), $basket_cookie, 0, "/", "i-s.group", false, false); //на год
...
setcookie("pr_", $_GET["id"], time() + 60 * 60 * 24 * 365, "/", "i-s.group", false, false); //на год
