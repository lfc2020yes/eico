...
//alert(files);
    if((contractor_new==0))
    {
        ...
        var data ='url='+window.location.href+'&id='+for_id+'&tk='+box_active.find('.h111').attr('mor')+'&object='+box_active.find("[name=forward_id]").val()+'&number='+box_active.find("[name=number_soply1]").val()+'&date1='+box_active.find("[name=date_soply]").val()+'&summa='+box_active.find("[name=summa_soply]").val()+'&new_c='+contractor_new+'&post_p='+box_active.find("[name=id_kto]").val()+'&com='+box_active.find("[name=text_comment]").val()+'&files='+files;
    } else
    {
...
//alert(files);
        ...
        var data ='url='+window.location.href+'&id='+for_id+'&tk='+box_active.find('.h111').attr('mor')+'&object='+box_active.find("[name=forward_id]").val()+'&name='+box_active.find("[name=number_soply1]").val()+'&link='+box_active.find("[name=link_soply1]").val()+'&summa='+box_active.find("[name=summa_soply]").val()+'&place='+box_active.find("[name=place_id]").val()+'&com='+box_active.find("[name=text_comment]").val();
