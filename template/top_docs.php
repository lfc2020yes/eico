...
//выполненные все
                    ...
                    if($menu_no_my!=0)
                    {
                        $tabs_menu_x = array("Ваши договора", "Выполнить", "Исполнено");
    ...
    <div class="menu-09-right tours-right-block">
        ...
        if (($role->permission('Договора','A'))or($sign_admin==1))
        {
            echo'<a data-tooltip="добавить Договор" class="js-add-docs add_clients yellow-style hide-mobile">Добавить →</a>';
