...
*/
    ...
    <div class="menu-09  input-line" style="z-index:150;">
        ...
        <div class="menu-09-left">
            <a href="/" class="menu-09-global"></a><a href="implementer/" class="menu-09-prev"><i></i></a>


            <?

            echo'<span class="menu-09-pc-h" ><span >'.htmlspecialchars_decode($row_list["implementer"]).'</span >';
        ...
        <div class="menu-09-right tours-right-block">
            ...
            if (($role->permission('Исполнители','U'))or($sign_admin==1))
            {
                ...
                echo'<a data-tooltip="Редактировать Исполнителя" class="imp_option add_clients ser-style hide-mobile">Изменить →</a>';
            ...
            if (($role->permission('Касса','R'))or($sign_admin==1))
            {
                if($row_list["summa_debt"]>0)
                {
                    if (($role->permission('Касса','A'))or($sign_admin==1))
                    {
                        ...
                        echo'<a id_rel="'.$row_list["id"].'" data-tooltip="Выдать" class="js-pay_baks_top add_clients green-bb hide-mobile">Выдать →</a>';
                ...
                if (($role->permission('Аванс','R'))or($sign_admin==1))
                {
                    ...
                    echo'<a id_avans="'.$row_list["id"].'" data-tooltip="Выдать аванс" class="js-pay_avans_top add_clients yellow-style hide-mobile">Аванс →</a>';
