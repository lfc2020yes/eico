        ...
        <div class="menu_client_w_org">
            <div class="mm_w">
                <ul class="tabs_hedi js-tabs-menuxx">
                    ...
                    $tabs_menu_x = array("Необработанные 1с", "История");
                    ...
                    for ($i=0; $i<count($tabs_menu_x); $i++)
                    {
                        if($i!=0)
                        {
                            ...
                            {
                                echo'<a href="invoices_1c/'.$tabs_menu_x_link[$i].'" class="tabsss_orgg active '.$tabs_menu_x_class[$i].'" id="'.$tabs_menu_x_id[$i].'">'.$tabs_menu_x[$i].' <i class="ystal">('.$tabs_menu_x_count[$i].')</i></a>';
                            } else
                            {
                                echo'<a href="invoices_1c/'.$tabs_menu_x_link[$i].'" class="tabsss_orgg '.$tabs_menu_x_class[$i].'" id="'.$tabs_menu_x_id[$i].'">'.$tabs_menu_x[$i].' <i class="ystal">('.$tabs_menu_x_count[$i].')</i></a>';
                            }
