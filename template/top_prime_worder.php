...
//выполненные все
                    ...
                    if($menu_no_my!=0)
                    {
                        $tabs_menu_x = array("Ваши Наряды", "Выполнить", "Исполнено");
                    ...
                    for ($i=0; $i<count($tabs_menu_x); $i++)
                    {
                        if($i!=0)
                        {
                            ...
                            {
                                echo'<a href="worder/'.$tabs_menu_x_link[$i].'" class="tabsss_orgg active '.$tabs_menu_x_class[$i].'" id="'.$tabs_menu_x_id[$i].'">'.$tabs_menu_x[$i].' <i class="ystal">('.$tabs_menu_x_count[$i].')</i></a>';
                            } else
                            {
                                echo'<a href="worder/'.$tabs_menu_x_link[$i].'" class="tabsss_orgg '.$tabs_menu_x_class[$i].'" id="'.$tabs_menu_x_id[$i].'">'.$tabs_menu_x[$i].' <i class="ystal">('.$tabs_menu_x_count[$i].')</i></a>';
                            }
