...
//выполненные все
                    ...
                    if($menu_no_my!=0)
                    {
                        $tabs_menu_x = array("Ваши тендеры", "Выполнить", "Исполнено");
    ...
    <div class="menu-09-right tours-right-block">
        ...
        if (($role->permission('Тендеры','A'))or($sign_admin==1))
        {
            echo'<a data-tooltip="добавить Тендер" class="js-add-tender add_clients yellow-style hide-mobile">Добавить →</a>';
