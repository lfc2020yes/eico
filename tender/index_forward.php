...
$title=$kto.' переслал тендер №'.$value['id'];


$kto1=name_sql_x($_POST["forward_id"]);


$message=$kto.' переслал тендер <a class="link-history" href="tender/'.$value['id'].'/">'.$value['name'].'</a>. Задача по тендеру поступила к - '.$kto1;
